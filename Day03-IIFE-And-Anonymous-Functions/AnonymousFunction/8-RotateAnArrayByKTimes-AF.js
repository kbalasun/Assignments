...
let rotateArrayNTimes=function(arrList,numberOfTimes){
    let arrayToBeRotated=arrList;
...
console.log("----------------------------------------------------------")
console.log("Array Before Rotation : "+rotateArrayNTimes(inputArrayToBeRotated,numberOfTimes));
